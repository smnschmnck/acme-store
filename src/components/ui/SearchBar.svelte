...
<form
	method="get"
	autocomplete="off"
	class="flex h-10 overflow-hidden rounded-lg bg-zinc-100 focus-within:outline focus-within:outline-1 focus-within:outline-blue-500"
>
	<Select className="rounded-none w-28">
